...
import { createRental, getAdminRentals, getMyRentals, getRentalAvailability, scheduleRentalPickup, submitRentalPayment, submitRentalReview, updateRentalStatus, createPaymongoPaymentLink, verifyPaymongoPayment } from '../controllers/rentalController.js';
...
router.post('/:id/paymongo-link', authenticate, createPaymongoPaymentLink);
router.post('/:id/paymongo-verify', authenticate, verifyPaymongoPayment);

...
import gownDesignerRoutes from './routes/gownDesigner.js';
...
// Security headers are applied before CORS and all route handlers.
...
app.use('/api/gown-designer', gownDesignerRoutes);
